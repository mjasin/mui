...
#pragma warning restore S1144 // Unused private types or members should be removed
        ...
        /// <summary>
        ///     <para>
        ///         Wrapper for VerSetConditionMask function (
        ...
        ///     <para>
        ///         A value to be passed as the dwlConditionMask parameter of
        ...
        ///     A mask that indicates the member of
        ///     the <see cref="OsVersionInfoEx" /> structure whose comparison
        ///     operator is being set.
        /// </param>
        /// <param name="dwConditionMask">
        ///     The operator to be used for the
        ///     comparison.
        /// </param>
        ...
        ///     system version requirements to compare.
        /// </param>
        /// <param name="dwTypeMask">
        ///     A mask that indicates the members of the
        ///     <see cref="OsVersionInfoEx" /> structure to be tested.
        /// </param>
        /// <param name="dwlConditionMask">
        ///     The type of comparison to be used
        ///     for each lpVersionInfo member being compared. Can be constructed
        ///     with <see cref="VerSetConditionMask" /> method.
        /// </param>
        /// <returns>
        ///     True if the current Windows OS satisfies the specified
        ...
        /// <param name="servicePackMajor">
        ///     The major Service Pack version
        ///     number.
        /// </param>
        /// <returns>
        ///     True if the the running OS matches, or is greater
        ...
        /// <returns>
        ///     True if the the running OS matches, or is greater
        ///     than, the specified OS; otherwise, false.
        /// </returns>
