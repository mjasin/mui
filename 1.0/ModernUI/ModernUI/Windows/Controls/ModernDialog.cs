...
namespace ModernUI.Windows.Controls
{
        ...
        : DpiAwareWindow
    {
        ...
        public static readonly DependencyProperty BackgroundContentProperty =
            DependencyProperty.Register("BackgroundContent", typeof(object), typeof(ModernDialog));
        ...
        public Button OkButton
        {
            get
            {
                if (okButton == null)
                {
                    okButton = CreateCloseDialogButton(ModernUI.Resources.Ok, true, false, MessageBoxResult.OK);
                }
                return okButton;
            }
        }
        ...
        public Button CancelButton
        {
            get
            {
                ...
                {
                    cancelButton = CreateCloseDialogButton(ModernUI.Resources.Cancel, false, true,
        ...
        public Button YesButton
        {
            get
            {
                if (yesButton == null)
                {
                    yesButton = CreateCloseDialogButton(ModernUI.Resources.Yes, true, false, MessageBoxResult.Yes);
                }
                return yesButton;
            }
        }
        ...
        public Button NoButton
        {
            get
            {
                if (noButton == null)
                {
                    noButton = CreateCloseDialogButton(ModernUI.Resources.No, false, true, MessageBoxResult.No);
                }
                return noButton;
            }
        }
        ...
        public Button CloseButton
        {
            get
            {
                if (closeButton == null)
                {
                    closeButton = CreateCloseDialogButton(ModernUI.Resources.Close, true, false, MessageBoxResult.None);
                }
                return closeButton;
            }
        }
