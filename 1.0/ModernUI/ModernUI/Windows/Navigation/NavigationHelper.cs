...
#pragma warning restore S3776 // Cognitive Complexity of methods should not be too high
        ...
        /// <returns></returns>
        public static bool TryParseUriWithParameters(object value, out Uri uri, out string parameter,
        ...
        /// <param name="targetName">Name of the target.</param>
        /// <returns></returns>
        public static bool TryParseUriWithParameters(string value, out Uri uri, out string parameter,
            out string targetName)
        {
            uri = null;
            parameter = null;
            ...
            string[] parts = uriString.Split(new[] {'|'}, 3);
            if (parts.Length == 3)
            {
                uriString = parts[0];
